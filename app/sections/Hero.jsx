  ...
  return (
    ...
    >
      <div className="flex flex-col items-center max-lg:flex max-lg:flex-col max-lg:items-center max-lg:text-center">
        <TextGenerateEffect words={words} className='font-corinthia text-8xl max-sm:text-6xl text-paradiso-700' />
        <h2 className="font-bold text-2xl text-paradiso-700">{job}</h2>
